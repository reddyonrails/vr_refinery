...
init_interface = function() {
  ...
  if (($menu = $('#menu')).length > 0) {
    $menu.jcarousel({
      vertical: false
      , scroll: 1
      , buttonNextHTML: "<img src='/images/carousel-right.png' alt='down' height='15' width='10' />"
      , buttonPrevHTML: "<img src='/images/carousel-left.png' alt='up' height='15' width='10' />"
  ...
  $('.form-actions .form-actions-left input:submit#submit_button').click(function(e) {
    $("<img src='/lib/refinerycms/core/public/images/refinery/icons/ajax-loader.gif' width='16' height='16' class='save-loader' />").appendTo($(this).parent());
  });
};
  ...
  $($(args != null ? args : 'a[title], span[title], #image_grid img[title], *[tooltip]')).not('.no-tooltip').each(function(index, element)
  {
    ...
    $(element).hover(function(e) {
      $(this).oneTime(350, 'tooltip', $.proxy(function() {
        ...
        nib = $("<img src='/lib/refinerycms/core/public/images/refinery/"+tooltip_nib_image+"' class='tooltip-nib'/>").appendTo('#tooltip_container');
